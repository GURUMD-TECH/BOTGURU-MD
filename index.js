//═══════════════════════════════════════════════════════//
//
//                              BOT GURU MD ..., MADE BY OFFICIAL GURU

//                                    GURU TECH BEST TECH EVER
//
//════════════════════════════//
...
Kon = await getBuffer(`https://hardianto.xyz/api/welcome3?profile=${encodeURIComponent(ppuser)}&name=${encodeURIComponent(nama)}&bg=https://photos.app.goo.gl/URNZDYRkgqRg82yr7=${encodeURIComponent(metadata.subject)}&member=${encodeURIComponent(memb)}`)

Tol = await getBuffer(`https://hardianto.xyz/api/goodbye3?profile=${encodeURIComponent(ppuser)}&name=${encodeURIComponent(nama)}&bg=https://photos.app.goo.gl/URNZDYRkgqRg82yr7=${encodeURIComponent(metadata.subject)}&member=${encodeURIComponent(memb)}`)
                if (anu.action == 'add') {
...
⭐✑ I'm Not Sure If It Was A Goodbye Charm, But It Was Fun While It Lasted 😌✨` })
    ...
    GojoMdNx.sendMedia = async (jid, path, fileName = '', caption = '', quoted = '', options = {}) => {
       ...
       await GojoMdNx.sendMessage(jid, { [type]: { url: pathFile }, caption, mimetype, f
